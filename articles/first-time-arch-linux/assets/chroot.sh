...
pacman --noconfirm -S iwd curl iputils vim dhcpcd sudo base-devel git man nvidia alsa-tools pulseaudio pulseaudio-bluetooth alsa-utils ttf-fira-code htop
...
pacman -S --noconfirm gnome gnome-tweaks gnome-shell-extensions networkmanager gnome-terminal gtk-engine-murrine gtk4 mesa powerline powerline-fonts gnome-bluetooth-3.0
